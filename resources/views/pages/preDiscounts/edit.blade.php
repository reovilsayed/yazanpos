<x-layout>
    ...
    <div class="card p-4">
        <form action="{{ route('pre-discounts.update', $preDiscount) }}" method="post">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-6">

                    <x-form.input name="title" :value="$preDiscount->title" label="Label" id="title" required />
                </div>
                <div class="col-md-6">

                    <x-form.input name="amount" :value="$preDiscount->amount" label="Discount Amount" id="amount"
                        required />
                </div>
            </div>
